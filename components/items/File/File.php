<?php
namespace Netstars\Media\Components\Items;
...
{   
     ...
     * @param string $name
     * @return \Netstars\Media\Components\Items\File\Details\ImageDetail
     */
     ...
     * @param string $name
     * @return \Netstars\Media\Components\Items\File\Details\FileDetail
     */
    ...
    {
	/* @var $content \Netstars\Media\Components\Content */
        $content = $this->lookup('Netstars\\Media\\Components\\Content');
	/* @var $media \Netstars\Media */
        $media = $this->lookup('Netstars\\Media');
    ...
    {
        $navBar = $this->lookup('Netstars\\Media\\Components\\NavBar');        
